...
**Not in scope yet:** separate **HLS** or **fMP4** packaging outputs (see [EPIC-lineup-parity](../epics/EPIC-lineup-parity.md) LP-010/LP-011 roadmap). Today’s profiles all target the existing TS relay path.
