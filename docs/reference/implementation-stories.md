---
id: implementation-stories
type: reference
status: stable
tags: [reference, phases, implementation, checklist]
---

# Implementation stories

Stories mapped from [architecture](../explanations/architecture.md) phased plan. Implement in order within each phase; Phase 1 is the skeleton.
