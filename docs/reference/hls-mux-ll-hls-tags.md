...
| Pattern | Behavior |
|--------|----------|
| **`URI="..."` on tag lines** | Any `#` line containing **`URI="`** (case-insensitive **`uri="`**) runs through **`rewriteHLSQuotedURIAttrs`**. This includes **`#EXT-X-PART`**, **`#EXT-X-PRELOAD-HINT`**, **`#EXT-X-RENDITION-REPORT`**, keys, maps, variants, media, session keys, etc. |
