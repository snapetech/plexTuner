...
internal/plexlabelproxy/proxy_test.go:1699:	if !strings.Contains(logBuf.String(), "outcome=source_mismatch") {
internal/plexlabelproxy/proxy_test.go:1700:		t.Fatalf("expected source_mismatch playback log, got %s", logBuf.String())
