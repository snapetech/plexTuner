...
# Generated: 2026-05-18T15:19:02Z
...
internal/plexlabelproxy/proxy_test.go:1265:	req := httptest.NewRequest(http.MethodGet, "/livetv/dvrs?X-Plex-Token=user-token", nil)
internal/plexlabelproxy/proxy_test.go:1269:	if got := req.URL.Query().Get("X-Plex-Token"); got != "owner-token" {
internal/plexlabelproxy/proxy_test.go:1272:	if got := req.Header.Get("X-Plex-Token"); got != "owner-token" {
internal/plexlabelproxy/proxy_test.go:1276:	library := httptest.NewRequest(http.MethodGet, "/library/sections?X-Plex-Token=user-token", nil)
internal/plexlabelproxy/proxy_test.go:1280:	if got := library.URL.Query().Get("X-Plex-Token"); got != "user-token" {
internal/plexlabelproxy/proxy_test.go:1285:	bait := httptest.NewRequest(http.MethodGet, "/library/sections?X-Plex-Token=user-token&bait=%2Flivetv%2Fdvr", nil)
internal/plexlabelproxy/proxy_test.go:1289:	if got := bait.URL.Query().Get("X-Plex-Token"); got != "user-token" {
internal/plexlabelproxy/proxy_test.go:1297:		gotToken = r.URL.Query().Get("X-Plex-Token")
internal/plexlabelproxy/proxy_test.go:1304:	proxy, err := New(Config{Upstream: up.URL, Token: "label-token", OwnerToken: "owner-token", ElevateLiveTV: true, UserHeader: true})
internal/plexlabelproxy/proxy_test.go:1310:	req := httptest.NewRequest(http.MethodGet, "/livetv/dvrs?X-Plex-Token=user-token", nil)
internal/plexlabelproxy/proxy_test.go:1330:	proxy, err := New(Config{Upstream: up.URL, Token: "label-token", OwnerToken: "owner-token", ElevateLiveTV: true, UserHeader: true})
internal/plexlabelproxy/proxy_test.go:1336:	req := httptest.NewRequest(http.MethodGet, "/library/sections?X-Plex-Token=user-token", nil)
internal/plexlabelproxy/proxy_test.go:1351:		requests = append(requests, seen{r.URL.Path, r.URL.Query().Get("X-Plex-Token")})
internal/plexlabelproxy/proxy_test.go:1357:	proxy, err := New(Config{Upstream: up.URL, Token: "label-token", OwnerToken: "owner-token", ElevateLiveTV: true, ElevateDiscoveryOnly: true})
internal/plexlabelproxy/proxy_test.go:1363:		"/livetv/dvrs?X-Plex-Token=user-token",
internal/plexlabelproxy/proxy_test.go:1364:		"/media/providers?X-Plex-Token=user-token",
internal/plexlabelproxy/proxy_test.go:1365:		"/video/:/transcode/universal/start.m3u8?X-Plex-Token=user-token&path=%2Flivetv%2Fsessions%2Fabc%2Findex.m3u8",
internal/plexlabelproxy/proxy_test.go:1366:		"/playQueues?X-Plex-Token=user-token&uri=%2Flivetv%2Fsessions%2Fabc%2Findex.m3u8",
internal/plexlabelproxy/proxy_test.go:1446:		OwnerToken:             "owner-token",
internal/plexlabelproxy/proxy_test.go:1447:		ElevateLiveTV:          true,
internal/plexlabelproxy/proxy_test.go:1458:		"/video/:/transcode/universal/start.m3u8?X-Plex-Token=user-token&path=%2Flivetv%2Fsessions%2Fabc%2Findex.m3u8",
internal/plexlabelproxy/proxy_test.go:1466:		"/:/scrobble?X-Plex-Token=user-token&ratingKey=9876&identifier=com.plexapp.plugins.library",
internal/plexlabelproxy/proxy_test.go:1492:		tokens = append(tokens, r.URL.Query().Get("X-Plex-Token"))
internal/plexlabelproxy/proxy_test.go:1502:		OwnerToken:             "owner-token",
internal/plexlabelproxy/proxy_test.go:1503:		ElevateLiveTV:          true,
internal/plexlabelproxy/proxy_test.go:1512:		"/video/:/transcode/universal/start.m3u8?X-Plex-Token=user-token&path=%2Flivetv%2Fsessions%2Fabc%2Findex.m3u8",
internal/plexlabelproxy/proxy_test.go:1523:		"/:/scrobble?X-Plex-Token=user-token&ratingKey=2468&identifier=com.plexapp.plugins.library",
internal/plexlabelproxy/proxy_test.go:1557:		tokens = append(tokens, r.URL.Query().Get("X-Plex-Token"))
internal/plexlabelproxy/proxy_test.go:1559:		if r.URL.Path == "/:/timeline" && r.URL.Query().Get("X-Plex-Token") != "owner-token" {
...
internal/plexlabelproxy/proxy_test.go:1581:		"/video/:/transcode/universal/start.m3u8?X-Plex-Token=user-token&path=%2Flivetv%2Fsessions%2Fabc%2Findex.m3u8",
internal/plexlabelproxy/proxy_test.go:1587:		"/:/timeline?X-Plex-Token=user-token&state=playing&ratingKey=2468",
internal/plexlabelproxy/proxy_test.go:1625:		tokens = append(tokens, r.URL.Query().Get("X-Plex-Token"))
internal/plexlabelproxy/proxy_test.go:1636:		OwnerToken:             "owner-token",
internal/plexlabelproxy/proxy_test.go:1637:		ElevateLiveTV:          true,
internal/plexlabelproxy/proxy_test.go:1647:		"/video/:/transcode/universal/start.m3u8?X-Plex-Token=user-token&path=%2Flivetv%2Fsessions%2Fabc%2Findex.m3u8",
internal/plexlabelproxy/proxy_test.go:1650:	streamReq.Header.Set("CF-Connecting-IP", "203.0.113.20")
internal/plexlabelproxy/proxy_test.go:1660:		"/:/scrobble?X-Plex-Token=user-token&ratingKey=2468&identifier=com.plexapp.plugins.library",
internal/plexlabelproxy/proxy_test.go:1663:	scrobbleReq.Header.Set("CF-Connecting-IP", "203.0.113.21")
internal/plexlabelproxy/proxy_test.go:1709:		OwnerToken:             "owner-token",
internal/plexlabelproxy/proxy_test.go:1710:		ElevateLiveTV:          true,
internal/plexlabelproxy/proxy_test.go:1719:		"/video/:/transcode/universal/start.m3u8?X-Plex-Token=user-token&path=%2Flivetv%2Fsessions%2Fabc%2Findex.m3u8&playQueueID=777",
internal/plexlabelproxy/proxy_test.go:1724:		"/:/scrobble?X-Plex-Token=user-token&ratingKey=1357&identifier=com.plexapp.plugins.library&playQueueID=777",
internal/plexlabelproxy/proxy_test.go:1768:func TestProxy_ElevateAll_InjectsOwnerTokenOnEveryRequest(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1771:		gotToken = r.URL.Query().Get("X-Plex-Token")
internal/plexlabelproxy/proxy_test.go:1780:		OwnerToken:      "owner-token",
internal/plexlabelproxy/proxy_test.go:1796:		req := httptest.NewRequest(http.MethodGet, path+"?X-Plex-Token=user-token", nil)
internal/plexlabelproxy/proxy_test.go:1807:		gotToken = r.URL.Query().Get("X-Plex-Token")
internal/plexlabelproxy/proxy_test.go:1816:		OwnerToken:      "owner-token",
internal/plexlabelproxy/proxy_test.go:1847:		OwnerToken:             "owner-token",
internal/plexlabelproxy/proxy_test.go:1859:		"/video/:/transcode/universal/start.m3u8?X-Plex-Token=owner-token&path=%2Flivetv%2Fsessions%2Fabc%2Findex.m3u8",
internal/plexlabelproxy/proxy_test.go:1865:		"/:/scrobble?X-Plex-Token=owner-token&ratingKey=42&identifier=com.plexapp.plugins.library",
internal/plexlabelproxy/proxy_test.go:1887:		tokens = append(tokens, r.URL.Query().Get("X-Plex-Token"))
internal/plexlabelproxy/proxy_test.go:1897:		OwnerToken:             "owner-token",
internal/plexlabelproxy/proxy_test.go:1908:		"/video/:/transcode/universal/start.m3u8?X-Plex-Token=user-token&path=%2Flivetv%2Fsessions%2Fabc%2Findex.m3u8",
internal/plexlabelproxy/proxy_test.go:1919:		"/:/scrobble?X-Plex-Token=user-token&ratingKey=99&identifier=com.plexapp.plugins.library",
internal/plexlabelproxy/proxy_test.go:1959:		tokens = append(tokens, r.URL.Query().Get("X-Plex-Token"))
internal/plexlabelproxy/proxy_test.go:1969:		OwnerToken:             "owner-token",
internal/plexlabelproxy/proxy_test.go:1981:		"/video/:/transcode/universal/start.m3u8?X-Plex-Token=user-token&path=%2Flibrary%2Fmetadata%2F123",
internal/plexlabelproxy/proxy_test.go:1992:		"/:/scrobble?X-Plex-Token=user-token&ratingKey=42&identifier=com.plexapp.plugins.library",
...
internal/plexlabelproxy/entitlement.go:260:// RewriteTunerEntitlementFlags rewrites the small XML/JSON hints Plex Web uses to
internal/plexlabelproxy/entitlement.go:262:// narrow: it only changes allowTuners fields and never rewrites account,
internal/plexlabelproxy/entitlement.go:264:func RewriteTunerEntitlementFlags(body []byte) []byte {
internal/plexlabelproxy/entitlement.go:265:	if len(body) == 0 || !bytes.Contains(body, []byte("allowTuners")) {
internal/plexlabelproxy/entitlement.go:268:	out := bytes.ReplaceAll(body, []byte(`allowTuners="0"`), []byte(`allowTuners="1"`))
internal/plexlabelproxy/entitlement.go:269:	out = bytes.ReplaceAll(out, []byte(`<Setting id="allowTuners" value="0"`), []byte(`<Setting id="allowTuners" value="1"`))
internal/plexlabelproxy/entitlement.go:270:	out = bytes.ReplaceAll(out, []byte(`"allowTuners":false`), []byte(`"allowTuners":true`))
internal/plexlabelproxy/entitlement.go:271:	out = bytes.ReplaceAll(out, []byte(`"allowTuners": false`), []byte(`"allowTuners": true`))
internal/plexlabelproxy/entitlement.go:272:	out = bytes.ReplaceAll(out, []byte(`"allowTuners":0`), []byte(`"allowTuners":1`))
internal/plexlabelproxy/entitlement.go:273:	out = bytes.ReplaceAll(out, []byte(`"allowTuners": 0`), []byte(`"allowTuners": 1`))
...
internal/plexlabelproxy/proxy_test.go:1172:func TestIsLiveTVRequest_MediaSubscriptionListsElevated(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1175:		if !IsLiveTVRequest(req) {
internal/plexlabelproxy/proxy_test.go:1178:		if !IsLiveTVDiscoveryRequest(req) {
internal/plexlabelproxy/proxy_test.go:1184:func TestIsLiveTVRequest_MediaSubscriptionRuleEditsElevatedOnlyWithLiveTVEvidence(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1229:			if got := IsLiveTVRequest(req); got != tc.want {
internal/plexlabelproxy/proxy_test.go:1230:				t.Fatalf("IsLiveTVRequest() = %v, want %v", got, tc.want)
internal/plexlabelproxy/proxy_test.go:1243:func TestIsLiveTVRequest_MediaSubscriptionLibraryItemNotElevated(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1245:	if IsLiveTVRequest(req) {
internal/plexlabelproxy/proxy_test.go:1252:	if IsLiveTVRequest(post) {
internal/plexlabelproxy/proxy_test.go:1257:func TestIsLiveTVRequest_OptionsPreflightNotElevated(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1259:	if IsLiveTVRequest(req) {
internal/plexlabelproxy/proxy_test.go:1264:func TestApplyLiveTVTokenElevation(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1266:	if !ApplyLiveTVTokenElevation(req, "owner-token") {
internal/plexlabelproxy/proxy_test.go:1277:	if ApplyLiveTVTokenElevation(library, "owner-token") {
internal/plexlabelproxy/proxy_test.go:1286:	if ApplyLiveTVTokenElevation(bait, "owner-token") {
internal/plexlabelproxy/proxy_test.go:1391:func TestIsLiveTVDiscoveryRequest(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1405:		if got := IsLiveTVDiscoveryRequest(req); got != want {
internal/plexlabelproxy/proxy_test.go:1406:			t.Errorf("IsLiveTVDiscoveryRequest(%q) = %v, want %v", target, got, want)
internal/plexlabelproxy/proxy_test.go:1411:func TestIsLiveTVStreamRequest(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1422:		if got := IsLiveTVStreamRequest(req); got != want {
internal/plexlabelproxy/proxy_test.go:1423:			t.Errorf("IsLiveTVStreamRequest(%q) = %v, want %v", target, got, want)
...
internal/plexlabelproxy/proxy_test.go:1428:func TestProxy_NeutralizeOwnerHistory_UnscrobblesFiredForTrackedSessions(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1448:		NeutralizeOwnerHistory: true,
internal/plexlabelproxy/proxy_test.go:1484:func TestProxy_NeutralizeOwnerHistory_CorrelatesByClientIdentifier(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1504:		NeutralizeOwnerHistory: true,
internal/plexlabelproxy/proxy_test.go:1549:func TestProxy_NeutralizeOwnerHistory_ElevatesTrackedTimelineResponse(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1573:		NeutralizeOwnerHistory: true,
internal/plexlabelproxy/proxy_test.go:1617:func TestProxy_NeutralizeOwnerHistory_DoesNotCorrelateDifferentSource(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1638:		NeutralizeOwnerHistory: true,
internal/plexlabelproxy/proxy_test.go:1691:func TestProxy_NeutralizeOwnerHistory_CorrelatesByPlayQueue(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1711:		NeutralizeOwnerHistory: true,
internal/plexlabelproxy/proxy_test.go:1849:		NeutralizeOwnerHistory: true,
internal/plexlabelproxy/proxy_test.go:1899:		NeutralizeOwnerHistory: true,
internal/plexlabelproxy/proxy_test.go:1971:		NeutralizeOwnerHistory: true,
...
scripts/ci-smoke.sh:875:fake_packager_ffmpeg="$TMP_DIR/fake-packager-ffmpeg.sh"
scripts/ci-smoke.sh:876:cat >"$fake_packager_ffmpeg" <<'SH'
scripts/ci-smoke.sh:900:chmod +x "$fake_packager_ffmpeg"
scripts/ci-smoke.sh:907:  IPTV_TUNERR_FFMPEG_PATH="$fake_packager_ffmpeg" \
scripts/ci-smoke.sh:915:grep -qi '^X-IptvTunerr-Shared-Upstream: ffmpeg_hls_packager' "$packager_second_headers" || fail "packaged hls second consumer missing shared upstream header"
scripts/ci-smoke.sh:949:fake_shared_ffmpeg="$TMP_DIR/fake-shared-ffmpeg.sh"
scripts/ci-smoke.sh:950:cat >"$fake_shared_ffmpeg" <<'SH'
scripts/ci-smoke.sh:955:printf 'ffmpeg'
scripts/ci-smoke.sh:957:chmod +x "$fake_shared_ffmpeg"
scripts/ci-smoke.sh:959:run_serve_env_ready "$TMP_DIR/catalog-remux.json" port_ffmpeg_shared "ffmpeg shared" "serve-ffmpeg-shared" \
scripts/ci-smoke.sh:964:  IPTV_TUNERR_FFMPEG_PATH="$fake_shared_ffmpeg" \
scripts/ci-smoke.sh:966:curl -sS "http://127.0.0.1:$port_ffmpeg_shared/stream/remux1" -o "$TMP_DIR/ffmpeg-shared-first.out" &
scripts/ci-smoke.sh:967:ffmpeg_shared_first_pid=$!
scripts/ci-smoke.sh:969:ffmpeg_shared_headers="$TMP_DIR/ffmpeg-shared-second.headers"
scripts/ci-smoke.sh:970:curl -sS -D "$ffmpeg_shared_headers" "http://127.0.0.1:$port_ffmpeg_shared/stream/remux1" -o "$TMP_DIR/ffmpeg-shared-second.out" &
scripts/ci-smoke.sh:971:ffmpeg_shared_second_pid=$!
scripts/ci-smoke.sh:973:grep -q '"count": 1' <(curl -sS "http://127.0.0.1:$port_ffmpeg_shared/debug/shared-relays.json") || fail "ffmpeg shared relay report missing active relay"
scripts/ci-smoke.sh:974:grep -q '"shared_upstream": "hls_ffmpeg"' <(curl -sS "http://127.0.0.1:$port_ffmpeg_shared/debug/shared-relays.json") || fail "ffmpeg shared relay report missing upstream label"
scripts/ci-smoke.sh:975:wait "$ffmpeg_shared_first_pid"
scripts/ci-smoke.sh:976:wait "$ffmpeg_shared_second_pid"
scripts/ci-smoke.sh:977:grep -qi '^X-IptvTunerr-Shared-Upstream: hls_ffmpeg' "$ffmpeg_shared_headers" || fail "ffmpeg shared second consumer missing shared upstream header"
scripts/ci-smoke.sh:978:[[ -s "$TMP_DIR/ffmpeg-shared-first.out" ]] || fail "ffmpeg shared first consumer got no bytes"
scripts/ci-smoke.sh:979:[[ -s "$TMP_DIR/ffmpeg-shared-second.out" ]] || fail "ffmpeg shared second consumer got no bytes"
scripts/ci-smoke.sh:980:assert_file_prefix "$TMP_DIR/ffmpeg-shared-second.out" "shared-"
scripts/ci-smoke.sh:982:run_serve_env_ready "$TMP_DIR/catalog-remux.json" port_ffmpeg_fmp4 "ffmpeg fmp4 shared" "serve-ffmpeg-fmp4" \
scripts/ci-smoke.sh:987:  IPTV_TUNERR_FFMPEG_PATH="$fake_shared_ffmpeg" \
scripts/ci-smoke.sh:990:curl -sS "http://127.0.0.1:$port_ffmpeg_fmp4/stream/remux1?profile=shared-fmp4" -o "$TMP_DIR/ffmpeg-fmp4-first.out" &
scripts/ci-smoke.sh:991:ffmpeg_fmp4_first_pid=$!
scripts/ci-smoke.sh:993:ffmpeg_fmp4_headers="$TMP_DIR/ffmpeg-fmp4-second.headers"
scripts/ci-smoke.sh:994:curl -sS -D "$ffmpeg_fmp4_headers" "http://127.0.0.1:$port_ffmpeg_fmp4/stream/remux1?profile=shared-fmp4" -o "$TMP_DIR/ffmpeg-fmp4-second.out" &
scripts/ci-smoke.sh:995:ffmpeg_fmp4_second_pid=$!
scripts/ci-smoke.sh:997:grep -q '"content_type": "video/mp4"' <(curl -sS "http://127.0.0.1:$port_ffmpeg_fmp4/debug/shared-relays.json") || fail "ffmpeg fmp4 shared relay report missing mp4 content type"
scripts/ci-smoke.sh:998:wait "$ffmpeg_fmp4_first_pid"
scripts/ci-smoke.sh:999:wait "$ffmpeg_fmp4_second_pid"
scripts/ci-smoke.sh:1000:grep -qi '^X-IptvTunerr-Shared-Upstream: hls_ffmpeg' "$ffmpeg_fmp4_headers" || fail "ffmpeg fmp4 second consumer missing shared upstream header"
scripts/ci-smoke.sh:1001:grep -qi '^Content-Type: video/mp4' "$ffmpeg_fmp4_headers" || fail "ffmpeg fmp4 second consumer missing video/mp4 content type"
scripts/ci-smoke.sh:1002:[[ -s "$TMP_DIR/ffmpeg-fmp4-first.out" ]] || fail "ffmpeg fmp4 first consumer got no bytes"
scripts/ci-smoke.sh:1003:[[ -s "$TMP_DIR/ffmpeg-fmp4-second.out" ]] || fail "ffmpeg fmp4 second consumer got no bytes"
scripts/ci-smoke.sh:1004:assert_file_prefix "$TMP_DIR/ffmpeg-fmp4-second.out" "shared-"
scripts/ci-smoke.sh:1046:fake_ffmpeg="$TMP_DIR/fake-ffmpeg.sh"
scripts/ci-smoke.sh:1047:cat >"$fake_ffmpeg" <<'SH'
scripts/ci-smoke.sh:1052:chmod +x "$fake_ffmpeg"
scripts/ci-smoke.sh:1059:  IPTV_TUNERR_FFMPEG_PATH="$fake_ffmpeg" \
...
internal/plexlabelproxy/entitlement.go:239:		if values, err := url.ParseQuery(string(body)); err == nil && queryParamIsLiveTVPath(values, name) {
