...
- Date: [DATE]
  ...
  Title: Configure project verification steps
  Context: New project from template
  Why it matters: CI needs verification commands to pass
  Evidence: scripts/verify-steps.sh is a placeholder
  Suggested fix: Copy verify-steps.sh.example and customize for your project
  Risk/Scope: low | fits current scope: yes
